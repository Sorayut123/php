...
<aside class="w-64 sidebar p-6 space-y-2 sticky top-0 h-screen">
    ...
    <ul class="space-y-1">
        ...
        <li>
            <a href="account_expert.php" class="sidebar-link" data-page="account_setting">
        ...
        <li>
            <a href="leaning_expert.php" class="sidebar-link" data-page="leaning">
                <i class="fas fa-book-open"></i>
                แหล่งการเรียนรู้
            </a>
        </li>
        <li>
            <a href="*" class="sidebar-link" data-page="leaning">
                <i class="fas fa-book-open"></i>
                ออกจากระบบ
            </a>
        </li>
